...
var readability = {
    ...
    getTextNodes: function (document_root) {
        ...
        var treewalker = document.createTreeWalker(document_root, NodeFilter.SHOW_TEXT, {
            acceptNode: function (node) {
                if (node.parentNode && node.parentNode.nodeName.toLowerCase() !== 'script' &&
                    node.parentNode.nodeName.toLowerCase() !== 'style' && node.parentNode.nodeName.toLowerCase() !== 'noscript') {
